...
{author: "Michael Sheets",
 ...
 settings: 
  [{settings: 
   ...
   {name: "Entity",
    scope: "entity",
    settings: {fontStyle: "", foreground: "#9B703F"}},
   {name: "Keyword",
    scope: "keyword",
    settings: {fontStyle: "", foreground: "#CDA869"}},
   {name: "Storage",
    scope: "storage",
    settings: {fontStyle: "", foreground: "#F9EE98"}},
   {name: "String",
    scope: "string",
    settings: {fontStyle: "", foreground: "#8F9D6A"}},
   {name: "Support",
    scope: "support",
    settings: {fontStyle: "", foreground: "#9B859D"}},
   ...
   {name: "♦ String embedded-source",
    scope: "string source",
    settings: {fontStyle: "", foreground: "#DAEFA3"}},
   {name: "♦ String constant",
    scope: "string constant",
    settings: {foreground: "#DDF2A4"}},
   {name: "♦ String.regexp",
    scope: "string.regexp",
    settings: {fontStyle: "", foreground: "#E9C062"}},
   ...
   {name: "♦ Support.function",
    ...
    settings: {fontStyle: "", foreground: "#DAD085"}},
   {name: "♦ Support.constant",
    scope: "support.constant",
    settings: {fontStyle: "", foreground: "#CF6A4C"}},
   ...
   {name: "⎇ diff.header",
    ...
    settings: 
     {background: "#0E2231", fontStyle: "italic", foreground: "#F8F8F8"}},
   {name: "⎇ diff.deleted",
