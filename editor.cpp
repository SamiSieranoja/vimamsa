...
void SEditor::mouseReleaseEvent(QMouseEvent *event)
{
    qDebug() << "QT: Mouse release";
        ...
        rb_funcall(NULL,rb_intern("qt_signal"),2,
                rb_str_new2("mouse_release"),
                rb_str_new2("")
                );
...
void SEditor::cursorPositionChanged()
{
...
void Editor::fileOpen()
{
    ...
    QString fn = QFileDialog::getOpenFileName(this, tr("Open File..."),
                                              QString(), tr("HTML-Files (* *.htm *.html *.txt);;All Files (*)"));


    if (!fn.isEmpty()) {
        rb_funcall(NULL,rb_intern("new_file_opened"),2,
...
char* clipboard_str  = qstring_to_cstr(text22);
        ...
        rb_funcall(NULL,rb_intern("system_clipboard_changed"),1,
                rb_str_new2(clipboard_str));
        free(clipboard_str);
...
void Editor::about()
{
    QMessageBox::about(this, tr("About"), tr("TODO:about"));
}
